...
class EnhancedMainWindow(QMainWindow):
    ...
    def create_right_panel(self) -> QWidget:
        ...
        print("\n" + "=" * 70)
        print("🔧 [DEBUG] create_right_panel() CALLED - Building right panel tabs")
        print("=" * 70)

        tabs = QTabWidget()
        tabs.setTabPosition(QTabWidget.TabPosition.North)

        # Tab 1: Trade Decisions
        try:
            print("🎯 [DEBUG] Step 1: Creating Trade Decisions tab - INCREMENT 2")
            print("🎯 [DEBUG] Step 2: Creating QWidget for decision tab...")
            decision_tab = QWidget()
            decision_layout = QVBoxLayout(decision_tab)
            print("🎯 [DEBUG] Step 3: Instantiating TradeDecisionWidget...")
            self.decision_widget = TradeDecisionWidget()
            print("🎯 [DEBUG] Step 4: Adding widget to layout...")
            decision_layout.addWidget(self.decision_widget)
            print("🎯 [DEBUG] Step 5: Adding tab to QTabWidget...")
            tabs.addTab(decision_tab, "🎯 Decisions")
            print("🎯 [DEBUG] ✅ ✅ ✅ DECISION TAB ADDED SUCCESSFULLY! ✅ ✅ ✅")
            print("=" * 70 + "\n")
        except Exception as e:
            print("=" * 70)
            print(f"❌ ❌ ❌ [ERROR] Failed to create Decisions tab: {e}")
            import traceback
            traceback.print_exc()
            print("=" * 70 + "\n")
        ...
        print(f"\n🔧 [DEBUG] Right panel created with {tab_count} tabs:")
    ...
    def on_opportunities_updated(self, opportunities: list):
        ...
        decisions = decision_engine.scan_all_opportunities(
            ...
            momentum_scanner=None,  # TODO: Add when available
            correlation_analyzer=None,  # TODO: Add when available
            news_predictor=None,  # TODO: Add when available
            risk_manager=risk_manager,
            mt5_connector=self.mt5_connector
        )

        # Update decision widget with top decisions
        if decisions:
